...
setwd(here::here('Expt5_data'))

data=here::here('Expt5_data') # path to data files
...
p2<- ggplot(sdt, aes(condition1, dprime, fill=condition1))+
  ...
  geom_pointrange(data=dsw, aes(y=dprime, ymin=dprime-ci, ymax=dprime+ci), size=1, color="black")+ 
  theme_bw(base_size=14)+
