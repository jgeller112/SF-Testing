...
LRD can be used as a shiny application or as a package. Below shows how to score cued recall automatically using the lrd package. I used the Shiny application for this due to the R package not being ready for use. 
