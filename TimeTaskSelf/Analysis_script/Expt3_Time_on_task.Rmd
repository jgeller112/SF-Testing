...
The LRD package scores cued response data. The data is loaded into a shiny application and then brought back in to R. The R code has some issues which is why we cant run it from here.
...
recall_time$new_id1<-rep(1:232, each=2)
recall_time$new_id1<-as.factor(recall_time$Sub.ID)
recall_time$cond<-as.factor(recall_time$cond)
recall_time$font<-as.factor(recall_time$font)
bfcue = anovaBF(Proportion.Correct ~ cond*font, recall_time, 
          whichRandom="new_id1")
